...
Feb2007$Voltage <- as.numeric(Feb2007$Voltage)
...
Feb2007$Global_reactive_power <- as.numeric(Feb2007$Global_reactive_power)

png(file="plot4.png", width=480, height=480)
par(mfrow = c(2,2))
plot(Feb2007$DateTime,Feb2007$Global_active_power, type="l", xlab = "",
     ylab = "Global Active Power")
plot(Feb2007$DateTime,Feb2007$Voltage, type="l", xlab = "datetime",
     ylab = "Voltage")  
...
plot(Feb2007$DateTime,Feb2007$Global_reactive_power, type="l", xlab = "datetime",
